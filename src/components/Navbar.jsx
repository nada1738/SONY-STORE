            ...
            <header className={
                ...
                <nav className='flex items-center justify-between nike-container'>
                    ...
                    active:scale-110 transition-all duration-300 relative'>
                         ...
                         bg-white shadow 
                        shadow-slate-100 w-4 h-4 text-[0.65rem ] 
                        leading-tight 
                        font-medium rounded-full 
                        flex items-center justify-center cursor-pointer 
                        hover:scale-110 transition-none duration-300 ${navState ? 'bg-slate-800 text-slate-100 shadow-slate-900' : 'bg-slate-100 text-slate-900 shadow-slate-100'}`}>
                                    0
                                </div>
                            </button>
                        </li>
